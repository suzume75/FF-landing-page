...
function Navbar() {
    return (
            ...
            <nav className="bg-white shadow-md flex flex-row justify-evenly items-center p-2">
                ...
                <a href="#" className="text-gray-600 hover:text-gray-800 ml-8 cursor-pointer">Home</a>
                <a href="#" className="text-gray-600 hover:text-gray-800 ml-8 cursor-pointer">Menu</a>
                <a href="#" className="text-gray-600 hover:text-gray-800 ml-8 cursor-pointer">Servises</a>
